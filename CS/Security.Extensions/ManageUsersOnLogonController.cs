...
namespace Security.Extensions {
    public class ManageUsersOnLogonController : ViewController<DetailView> {
        ...
        public ManageUsersOnLogonController() {
            ...
            RegisterUserAction = CreateLogonParametersAction("RegisterUser", "RegisterUserCategory", "Register User", "BO_User", "Register a new user within the system", typeof(RegisterUserParameters));
            RestorePasswordAction = CreateLogonParametersAction("RestorePassword", "RestorePasswordCategory", "Restore Password", "Action_ResetPassword", "Restore forgotten login information", typeof(RestorePasswordParameters));
