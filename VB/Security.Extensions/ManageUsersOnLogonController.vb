...
Namespace Security.Extensions
    Public Class ManageUsersOnLogonController
        ...
        Public Sub New()
            ...
            Dim defaltCategory As String = PredefinedCategory.PopupActions.ToString()
            RegisterUserAction = CreateLogonParametersAction("RegisterUser", defaltCategory, "Register User", "BO_User", "Register a new user within the system", GetType(RegisterUserParameters))
            RestorePasswordAction = CreateLogonParametersAction("RestorePassword", defaltCategory, "Restore Password", "Action_ResetPassword", "Restore forgotten login information", GetType(RestorePasswordParameters))
            AcceptLogonParametersAction = New SimpleAction(Me, "AcceptLogonParameters", defaltCategory, Sub(s, e) AcceptParameters(TryCast(e.CurrentObject, LogonActionParametersBase)))
            AcceptLogonParametersAction.Caption = "OK"
            CancelLogonParametersAction = New SimpleAction(Me, "CancelLogonParameters", defaltCategory, Sub(s, e) CancelParameters(TryCast(e.CurrentObject, LogonActionParametersBase)))
        ...
        Protected Overrides Sub OnViewControlsCreated()
            ...
            RegisterUserAction.Active(LogonActionParametersActiveKey) = Not isLogonParametersActionView
            RestorePasswordAction.Active(LogonActionParametersActiveKey) = Not isLogonParametersActionView
        End Sub
	...
	Application.Modules.FindModule(Of ValidationModule)().InitializeRuleSet() 'T461096, T390268            
        ...
        Protected Overridable Sub AcceptParameters(ByVal parameters As LogonActionParametersBase)
            ...
            If registerUserParameters IsNot Nothing Then
                ...
                If lc IsNot Nothing Then
                    ...
                    Dim securitySystemLogonParameters As AuthenticationStandardLogonParameters = CType(SecuritySystem.LogonParameters, AuthenticationStandardLogonParameters)
